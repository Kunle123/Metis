...
export function DenseSection({
  ...
  return (
    <section className={cn("space-y-1.5 border-t border-white/8 pt-4 first:border-t-0 first:pt-0", className)}>
      <h3 className={cn("text-[0.7rem] font-medium uppercase tracking-[0.22em] text-[rgba(176,171,160,0.72)]", titleClassName)}>
        {title}
      </h3>
